...
class EditTransactionDialog:
    def __init__(self, parent, transaction):
        ...
        self.top.title(f"Edit Transaction")
        ...
        # From/To fields based on transaction type
        if transaction["type"] == "Deposit":
            # For Deposit: "From" field only
            ...
            self.from_entry.insert(0, transaction.get("from_account", ""))
            
            self.to_entry = None
        else:
            # For Withdrawal: "To" field only
            ...
            self.to_entry.insert(0, transaction.get("to_account", ""))
        ...
        self.desc_entry.insert(0, transaction.get("description", ""))
        
        # Buttons
        button_frame = Frame(form_frame, bg='#f0f0f0')
        button_frame.pack(pady=20)
        
        Button(button_frame, text="Update", command=self.ok, font=("Arial", 12, "bold"), 
